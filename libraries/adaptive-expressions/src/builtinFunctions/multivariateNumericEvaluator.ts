...
export class MultivariateNumericEvaluator extends ExpressionEvaluator {
     ...
     */
    public constructor(type: string, func: (args: unknown[]) => number, verify?: VerifyExpression) {
        super(
            type,
     ...
     * @private
     */
    private static evaluator(func: (args: unknown[]) => number, verify?: VerifyExpression): EvaluateExpressionDelegate {
